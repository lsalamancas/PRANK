...
\usepackage{amssymb} %Math symbols (blacktriangle, etc.)
...
\titleformat{\chapter}[hang]
  {\large\bfseries\MakeUppercase}{\thechapter.}{0.6em}{}
...
\include{Chapters/proposal_sumary}
\include{Chapters/abstrac}
\tableofcontents
\listoffigures
\listoftables
...
\include{Chapters/project_justification}
\include{Chapters/state_art}
\include{Chapters/objectives}
\include{Chapters/delimitation_scope}
\include{Chapters/hypothesis}
\include{Chapters/theorical_framework}
\include{Chapters/methods}
\include{Chapters/schedule}
\include{Chapters/project_resources}
\printbibliography
